...
namespace HighwayToPeak.Core
{
    public class Controller : IController
    {
        ...
        public string AddPeak(string name, int elevation, string difficultyLevel) //check
        {
            IPeak peak;
        ...
        public string AttackPeak(string climberName, string peakName) //check
        {
        ...
        public string NewClimberAtCamp(string name, bool isOxygenUsed) //check
        {
            IClimber climber;
