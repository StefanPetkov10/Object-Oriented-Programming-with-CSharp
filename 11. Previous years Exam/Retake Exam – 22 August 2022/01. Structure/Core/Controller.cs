...
namespace BookingApp.Core
{
    public class Controller : IController
    {
        ...
        public string AddHotel(string hotelName, int category)
        {
            ...
            {
                throw new ArgumentException(string.Format(OutputMessages.HotelAlreadyRegistered, hotelName));
            }
            hotel = new Hotel(hotelName, category);
            hotels.AddNew(hotel);
            return string.Format(OutputMessages.HotelSuccessfullyRegistered, hotelName);
        }
        public string UploadRoomTypes(string hotelName, string roomTypeName)
        {
            ...
            {
                return string.Format(OutputMessages.RoomTypeInvalid, roomTypeName);
            }
